...
from atreides.contracts.custody_object import CustodyObject
...
from atreides.contracts.settlement import SettlementMethod
...
class CustodyOperation(BaseModel):
    ...
    ``atreides.contracts.operations.equity`` and siblings. Each subclass
