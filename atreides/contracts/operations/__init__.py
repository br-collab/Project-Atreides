...
The base ``CustodyOperation`` lives in ``atreides.contracts.operations.base``
...
from atreides.contracts.operations.fixed_income import (
    FixedIncomeOperation,
    FixedIncomeTransactionType,
)
from atreides.contracts.operations.funds import (
    FundOperation,
    FundTransactionType,
)
