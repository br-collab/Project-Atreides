...
class ApprovedPath(BaseModel):
    ...
    path_id: str = Field(
        ...
        description=(
            ...
            ":class:`~atreides.agents.tier2.outputs.RoutingRecommendation` "
...
class RoutingTables(BaseModel):
    ...
    :mod:`atreides.agents.tier2.fiat_operations_specialist`); per-decision
    ...
    def find_path(self, path_id: str) -> ApprovedPath | None:
        ...
        :class:`~atreides.agents.tier2.outputs.RoutingDecision`.
        """
        for path in self.paths:
