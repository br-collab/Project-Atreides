...
- :class:`FIATOperationsSpecialist` — the agent class. Construction
  injects the :class:`~atreides.agents.tier2.routing_tables.RoutingTables`
...
class FIATOperationsSpecialist:
    ...
    :class:`~atreides.agents.tier2.routing_tables.RoutingTables`
    ...
    def enforce_eligibility(
        ...
        Delegates to :func:`atreides.agents.tier2.eligibility.verify_eligibility`
    ...
    def _check_material_magnitude(  # noqa: PLR0911 — one return per trigger / dimension is the clearest dispatch.
        ...
        *,
        ...
        0. **Operation already pre-classified** — the architectural-
           ...
           still propagate; the
           :class:`~atreides.agents.tier2.outputs.QuorumAuthorityRequired`
        ...
        1. **Sanctioned-jurisdiction adjacency** (CUS Section VI line
           ...
           :attr:`~atreides.contracts.InherentSafetySurface.FIAT_SETTLEMENT_MATERIAL`
