...
:class:`~atreides.agents.tier2.outputs.EligibilityVerification` from a
typed :class:`EligibilityInputs` package. The five checks per
:class:`~atreides.agents.tier2.outputs.EligibilityCheckKind` are:
...
def verify_eligibility(inputs: EligibilityInputs) -> EligibilityVerification:
    ...
    :class:`~atreides.agents.tier2.outputs.EligibilityVerification`.
    ...
    emits an
    :class:`~atreides.agents.tier2.outputs.EscalationRequired` with
