...
- **Counterparty credit assessment.** The live securities settlement gate (Cato Sec) is a market-regime gate; counterparty-credit signals are an explicit, documented out-of-scope decision pending a future doctrine version. (Canonical §I, scope.)
